...
.navbar-default     bg: #00629b, white links
  ...
  active underline: 3px solid #ffcd00 where the Decorator CSS applies it
...
- `https://developer.ucsd.edu/sitemap.xml` - verified June 18, 2026
- Current non-archive Developer/Decorator pages - verified June 18, 2026
- Decorator 5 Kitchen Sink - verified June 18, 2026
- Decorator 5 CSS (`base.min.css`) - verified June 18, 2026
